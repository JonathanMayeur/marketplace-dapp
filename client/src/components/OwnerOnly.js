            ...
            <div>
                    ...
                    <Col xs="10">
                        <Form style={styleF}>
                            <FormGroup>
                                    ...
                                    <FormText style={styleFG} id="newAdminFormText">_</FormText>
                            </FormGroup>
                        </Form>
                    </Col>
                    <Col xs="2">
                ...
                <Row>
                    <Col xs="10">
                        <Form style={styleF}>
                            <FormGroup>
                                    <Input type="text" id="disableAdminAddress" placeholder="disable Admin Address" />
                                    <FormText style={styleFG} id="disableAdminFormText">_</FormText>
                            </FormGroup>
                        </Form>
                    </Col>
                    <Col xs="2">
                ...
                <Row>
                    <Col xs="10">
                        <Form style={styleF}>
                            <FormGroup>
                                    <Input type="text" id="checkAdminAddress" placeholder="check if address is admin" />
                                    <FormText style={styleFG} id="checkAdminFormText"> admins() returned _</FormText>
                            </FormGroup>
                        </Form>
                    </Col>
                    <Col xs="2">
                        <Button style={styleBtn} onClick={onClickCheck}>check</Button>
                    </Col>
                </Row>
                <br />
            </div>
